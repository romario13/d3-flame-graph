(function () {
    ...
    function flameGraph() {
        ...
        var w = window.screen.availWidth * 0.97, // graph width
            h = window.screen.availHeight * 0.71, // graph height
            c = 18, // cell height
        ...
        function setSearchSum(t) {
            var searchSum = document.getElementById("search-sum");
            if (searchSum) {
                if (t > 0) {
                    searchSum.innerHTML = "Search sum is " + d3.round(100 * t, 3) + "%";
                } else {
                    searchSum.innerHTML = "";
                }
            }
        ...
        function calculateSearchSum(d, term) {
            ...
            selection.each(function (data) {
                ...
                g.transition()
                    ...
                    .attr("transform", function (d) {
                        return "translate(" + x(d.x) + "," + (h - y(d.depth) - c) + ")";
                    });
        ...
        chart.search = function (term) {
            ...
            selection.each(function (data) {
                ...
                setSearchSum(calculateSearchSum(data, term));
                update();
            });
            return searchResults;
        };
